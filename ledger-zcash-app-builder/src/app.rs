...
use zcash_primitives::{
    ...
    sapling::{redjubjub::Signature, Diversifier, Node, Note, Nullifier, PaymentAddress, ProofGenerationKey, Rseed},
    transaction::{
    ...
    E::Error: std::error::Error,
{
    ...
    pub async fn get_spendinfo(
        ...
        let proofkey = ProofGenerationKey { ak: ak.unwrap(), nsk: nsk.unwrap() };
    ...
    pub async fn get_outputinfo(&self) -> Result<(jubjub::Fr, Rseed, Option<HashSeed>), LedgerAppError<E::Error>> {
